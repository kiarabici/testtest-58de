[testtest-58de] Operating Details
====================================

Generated On: 2024-10-15 16:55:06 UTC
...
.. important::
   ...
   **not be valid if your [testtest-58de] container is NOT running**.

.. tip::
   You must have your [testtest-58de] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/kiarabici/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/kiarabici/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=41087  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='kiarabici'  \-\-env DOCKERUSERNAME='kiarabici'  \-\-env MQTTUSERNAME='kiarabici'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   kiarabici/testtest-58de-amd64 (https://hub.docker.com/r/kiarabici/testtest-58de-amd64)
...
.. important::
   docker run -d -p 55421:55421 -p 45251:45251 -p 36613:36613 \-\-env TSS=0 \-\-env SOLUTIONNAME=testtest-58de \-\-env SOLUTIONDAG=solution_preprocessing_dag-testtest-58de \-\-env GITUSERNAME=kiarabici  \-\-env GITREPOURL=https://github.com/kiarabici/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=55421  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=45251  \-\-env SOLUTIONVIPERVIZPORT=36613 \-\-env DOCKERUSERNAME='kiarabici'  \-\-env EXTERNALPORT=41087 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='kiarabici' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  kiarabici/testtest-58de-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=36613
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=55421
...
It can be accessed by entering: http://localhost:45251
...
.. important::
   http://localhost:36613/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:36613/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:36613/<html file>
...
[testtest-58de] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/kiarabici/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/testtest-58de
...
.. important::
   https://testtest-58de.readthedocs.io
...
.. important::
   solution_preprocessing_dag-testtest-58de
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=55421, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=42577, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=38731, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=41527, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=34591, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=40855, HPDEHOST=127.0.1.1, HPDEPORT=34371, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=38887

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-2366-testtest-58de,solution_preprocessing_dag-testtest-58de, python-preprocess-5746-testtest-58de,solution_preprocessing_dag-testtest-58de, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
